              ...
              <Tabs defaultValue="all-records" className="w-full">
                <div className="flex items-center gap-x-5 my-2">
                  <TabsList className="grid w-80 grid-cols-2 h-12 p-2">
                    <TabsTrigger value="all-records" className="data-[state=active]:text-destructive">All Records</TabsTrigger>
                    <TabsTrigger value="requests" className="data-[state=active]:text-destructive">Requests</TabsTrigger>
                  </TabsList>
